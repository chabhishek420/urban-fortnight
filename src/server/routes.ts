 ...
 * API v1 routes
 */
function registerApiV1Routes(fastify: FastifyInstance): void {
  // Campaigns
 ...
 * Admin routes
 */
function registerAdminRoutes(fastify: FastifyInstance): void {
  // Login page
 ...
 * Gateway routes (for tracking redirects)
 */
function registerGatewayRoutes(fastify: FastifyInstance): void {
  // Redirect gateway
 ...
 */
function registerTrackingRoutes(fastify: FastifyInstance): void {
  // Main index route
  fastify.get('/', async (_request, reply) => {
 ...
 */
export function buildServerRequest(request: FastifyRequest): ServerRequest {
