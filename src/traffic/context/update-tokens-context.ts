...
import { UpdateTokensDispatcher } from '../dispatcher/update-tokens-dispatcher';

export class UpdateTokensContext extends BaseContext {
  /**
  ...
  dispatcher(_request: ServerRequest): DispatcherInterface {
    return new UpdateTokensDispatcher();
  }
