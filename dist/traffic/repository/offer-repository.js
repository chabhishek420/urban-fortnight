 ...
 */
class OfferRepository extends base_repository_js_1.BaseRepository {
    /**
     ...
     */
    async findByAffiliateNetworkId(affiliateNetworkId, options) {
        return this.findAll({
            ...options,
     ...
     */
    async findAllActiveOffers(options) {
     ...
     */
    async findAlternativeOffer(offerId) {
    ...
    async findOffersAtDailyCap() {
        ...
        return this.findAll({
            where: {
                ...
                state: state_js_1.EntityState.ACTIVE
            }
        });
    }
}
