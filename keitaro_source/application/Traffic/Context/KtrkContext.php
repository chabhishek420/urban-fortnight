...
class KtrkContext implements \Core\Context\ContextInterface
{
    ...
    {
        \Traffic\Logging\Service\TrafficLoggerService::instance()->entry()->add("[KtrkContext]");
        ...
        return new \Traffic\Dispatcher\KtrkDispatcher($pipelinePayload, 2);
    }
