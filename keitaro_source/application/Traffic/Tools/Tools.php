...
class Tools
{
    ...
    public static function isValidCIDR($cidr)
    {
        ...
        $mustCidr = false;
        if ($netmask != "" && 32 < $netmask && !$mustCidr || ($netmask == "" || 32 < $netmask) && $mustCidr) {
            return false;
        }
        return true;
    }
    ...
    public static function ipInInterval($ip, $interval)
    {
        ...
        return Tools::ip2long(trim($from)) <= Tools::ip2long($ip) && Tools::ip2long($ip) <= Tools::ip2long(trim($to));
    }
    ...
    {
        $tbl = ["а" => "a", "б" => "b", "в" => "v", "г" => "g", "д" => "d", "е" => "e", "ж" => "zh", "з" => "z", "и" => "i", "й" => "y", "к" => "c", "л" => "l", "м" => "m", "н" => "n", "о" => "o", "п" => "p", "р" => "r", "с" => "s", "т" => "t", "у" => "u", "ф" => "f", "ы" => "i", "э" => "e", "А" => "A", "Б" => "B", "В" => "V", "Г" => "G", "Д" => "D", "Е" => "E", "Ж" => "G", "З" => "Z", "И" => "I", "Й" => "Y", "К" => "K", "Л" => "L", "М" => "M", "Н" => "N", "О" => "O", "П" => "P", "Р" => "R", "С" => "S", "Т" => "T", "У" => "U", "Ф" => "F", "Ы" => "I", "Э" => "E", "ё" => "yo", "х" => "h", "ц" => "ts", "ч" => "ch", "ш" => "sh", "щ" => "shch", "ъ" => "", "ь" => "", "ю" => "yu", "я" => "ya", "Ё" => "YO", "Х" => "H", "Ц" => "TS", "Ч" => "CH", "Ш" => "SH", "Щ" => "SHCH", "Ъ" => "", "Ь" => "", "Ю" => "YU", "Я" => "YA", "і" => "i", "ї" => "ji", "І" => "I", "Ї" => "Ji", "'" => ""];
    ...
    public static function utf8ize($d)
    {
        if (is_array($d)) {
            ...
            if (is_string($d) && !mb_detect_encoding($d, ["UTF-8"], true)) {
                if (mb_detect_encoding($d, ["WINDOWS-1251"], true)) {
