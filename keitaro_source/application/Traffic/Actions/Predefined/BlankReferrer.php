...
class BlankReferrer extends \Traffic\Actions\AbstractAction
{
    protected $_weight = 3;
    ...
    {
        $code = \Traffic\Actions\Service\RedirectService::instance()->metaRedirect($this->getActionPayload(), $this->_options());
    ...
    private function _options($_options)
    {
        return ["delay" => 0, "no_referrer" => true];
    }
}
