...
class CacheCampaignTokens implements EventHandlerInterface
{
    ...
    {
        $hash = \Traffic\CachedData\DataGetter\GetCampaignTokens::buildHash();
        $storage->set(\Traffic\CachedData\DataGetter\GetCampaignTokens::CACHE_KEY, $hash);
    }
}
