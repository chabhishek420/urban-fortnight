...
CREATE TABLE IF NOT EXISTS `keitaro_affiliate_networks` (
  ...
  `pull_api_options` text DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `keitaro_conversions_2` (
  ...
  `x_requested_with_id` int(10) unsigned DEFAULT NULL,
  `previous_conversion_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`conversion_id`),
  KEY `campaign_id` (`campaign_id`),
  KEY `affiliate_network_id` (`affiliate_network_id`),
  KEY `x_requested_with_id` (`x_requested_with_id`),
  KEY `sub_id_tid` (`sub_id`,`tid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `keitaro_domains` (
  ...
  `redirect` varchar(255) DEFAULT 'not',
  `ssl_data` text DEFAULT NULL,
  `is_robots_allowed` tinyint(1) unsigned DEFAULT 1,
  `next_check_at` datetime DEFAULT NULL,
  `ssl_redirect` tinyint(1) unsigned DEFAULT 0,
  `allow_indexing` tinyint(1) unsigned DEFAULT 1,
  `check_retries` int(10) unsigned DEFAULT 0,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `keitaro_labels` (
  ...
  `ref_id` int(12) unsigned DEFAULT NULL,
  `ref_value` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `campaign_name_id` (`campaign_id`,`ref_name`,`ref_id`),
  UNIQUE KEY `campaign_name_value` (`campaign_id`,`ref_name`,`ref_value`),
...
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20180809124704_AddRboosterConfigSection');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20180825100512_AddStorageSetting');
...
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20181010122302_RemoveUniqIndexInConversions');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20181012083327_AddPreviousConversionId');
...
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20200319131723_AddIndexParentSubIdClickLinks');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20200408164315_AddDefaultActionAllowed');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20200420153756_AddDomainSSLStatusColumn');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20200723060010_UpdateLpOfferTokenTTLColumn');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20200907090524_AddRedirectToDomains');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20200907092913_AddSSLDataToDomains');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20200916203415_AddRobotsToDomains');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20201120124115_AddNextCheckAtToDomains');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20201123113415_RenameRedirectInDomains');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20201127082007_RenameIsRobotsAllowedInDomains');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20201203061229_AddShareToStreams');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20201203061535_DeleteUnusedFieldsOnStreams');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20201203061755_DeleteUnusedTables');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20201204163415_RenamePreviousCheckAtInDomains');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20201204163520_AddCheckRetriesToDomains');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20201213200257_AddSettingEnableCookies');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20201227061229_FixShare');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210120144304_RenameShareToWeight');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210121125645_RestoreChanceInStreams');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210126194546_RestoreStreamShare');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210201094723_RestoreDomainRedirect');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210404212150_ExpireOldIpSessions');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210512173255_AddLpPhpTimeoutSetting');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210603054616_DownloadTemplates');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210615074726_AddSettingForcedReportDateTimezone');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210706120502_NullifyUserPassword');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210811130145_FixConversionsIndicies');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210825173025_AddDomainUniqueIndex');
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20210827074848_AddRefValueToLabels');
