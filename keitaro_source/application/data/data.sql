...
INSERT IGNORE INTO `keitaro_settings` (`key`, `value`) VALUES ('cache_storage', 'files');
...
INSERT IGNORE INTO `keitaro_settings` (`key`, `value`) VALUES ('draft_data_storage', 'redis');
INSERT IGNORE INTO `keitaro_settings` (`key`, `value`) VALUES ('extra_action', 'not_found');
...
INSERT IGNORE INTO `keitaro_settings` (`key`, `value`) VALUES ('lp_allow_php', '1');
INSERT IGNORE INTO `keitaro_settings` (`key`, `value`) VALUES ('lp_php_timeout', '1');
...
INSERT IGNORE INTO `keitaro_settings` (`key`, `value`) VALUES ('cookies_enabled', '1');
...
INSERT IGNORE INTO `keitaro_settings` (`key`, `value`) VALUES ('default_action_allowed', '0');

INSERT IGNORE INTO `keitaro_settings` (`key`, `value`) VALUES ('campaign_autosave', '0');

INSERT IGNORE INTO `keitaro_settings` (`key`, `value`) VALUES ('data_storage', 'mysql');
INSERT IGNORE INTO `keitaro_settings` (`key`, `value`) VALUES ('forced_report_utc_timezone', '1');
